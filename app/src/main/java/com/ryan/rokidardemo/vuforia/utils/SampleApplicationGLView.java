...
package com.ryan.rokidardemo.vuforia.utils;
...
public class SampleApplicationGLView extends GLSurfaceView
{
    ...
    public void init(boolean translucent, int depth, int stencil)
    {
        ...
        Logger.d( "Using OpenGL ES 2.0");
        Logger.d("Using " + (translucent ? "translucent" : "opaque")
        ...
        EGLContextFactory
    {
                                        ...
                                        EGLConfig eglConfig)
        {
            ...
            Logger.d("Creating OpenGL ES 2.0 context");
    ...
    private static void checkEglError(String prompt, EGL10 egl)
    {
        ...
        {
            Logger.e(String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
